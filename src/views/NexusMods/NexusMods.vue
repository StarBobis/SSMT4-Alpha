...
<style scoped>
.nexusmods-page { height:100%; min-height:0; box-sizing:border-box; display:flex; flex-direction:column; gap:var(--t-page-gap); overflow:hidden; padding:var(--t-page-padding); color:var(--t-page-text); }
